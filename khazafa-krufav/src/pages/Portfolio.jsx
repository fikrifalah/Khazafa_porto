  ...
  return (
    <div className="px-6 py-12 md:py-20">
      <div className="mb-12 flex flex-col items-start justify-between gap-4 border-b border-zinc-900 pb-8 md:flex-row md:items-end">
        <div>
          <h2 className="text-4xl font-black tracking-tight text-white md:text-6xl">SELECTED WORK</h2>
          <p className="mt-2 text-zinc-500">Feature films and short narratives from 2020-2024.</p>
        </div>
