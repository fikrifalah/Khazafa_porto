...
const About = () => {
  ...
  return (
    // FIX 1: Added 'w-full' and 'overflow-hidden'
    <div className="mx-auto max-w-5xl w-full overflow-hidden px-6 py-12 md:py-20">
      ...
      <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-center">
        ...
        {/* FIX: Added min-w-0 and flex-1 so text wraps next to image */}
        <div className="min-w-0 flex-1">
          {/* FIX 2: Added 'break-words' */}
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        <section className="min-w-0">
          ...
          {/* FIX 4: Corrected grid class to 'sm:grid-cols-1' */}
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-2">
        ...
        <section className="flex flex-col gap-6 min-w-0">
          <div>
            ...
            <blockquote className="border-l-4 border-orange-600 bg-zinc-900/50 p-4 text-lg italic text-zinc-300 break-words whitespace-pre-wrap">
          ...
          <div>
            ...
            {/* FIX: Added break-words and whitespace-pre-wrap */}
            <div className="rounded-lg bg-orange-900/20 p-6 text-orange-200 border border-orange-900/30 break-words whitespace-pre-wrap">
